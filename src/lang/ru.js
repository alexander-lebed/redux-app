...
const translation: Translation = {
    ...
    CV: {
        BASIC_INFO: {
            ...
            ABOUT_ME: <span>Шестилетний практический опыт эффективного программирования на back и front-end, в основном в веб-разработке.<br/>Я проактивный, аккуратный, внимательный, быстро учусь, гибок к изменениям.</span>,
