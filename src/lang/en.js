...
const translation: TranslationType = {
    ...
    CV: {
        BASIC_INFO: {
            ...
            ABOUT_ME: <div>With six years of hands-on experience efficiently coding on back and front-end, mostly in web development.<br/>I am proactive, fast learner, accurate, eye-for-details, flexible for changes.</div>,
